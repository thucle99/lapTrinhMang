...
public class SearchStudent extends javax.swing.JFrame {
    ...
    public void searchStudent(String key) {
        ArrayList<Student> students = clientController.searchStudent(key);
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
//        tb.setRowCount(students.size());
//        for(int i=0;i<students.size();i++){
//            jTable1.setValueAt(students.get(i).getId(), i, 0);
//            jTable1.setValueAt(students.get(i).getTen(), i, 1);
//            jTable1.setValueAt(students.get(i).getNgaysinh(), i, 2);
//            jTable1.setValueAt(students.get(i).getKhoa(), i, 3);
//            jTable1.setValueAt(students.get(i).getQuequan(), i, 4);
//        }
        dtm.setRowCount(0);
        for (Student sv : students) {
            dtm.addRow(sv.toObjects());
        }
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row < 0 || row > dtm.getRowCount()) {
            JOptionPane.showMessageDialog(this, "chon sinh vien can sua");
        } else {
